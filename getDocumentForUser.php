...
//$sql = "SELECT u.username,u.userID,d.*,p.permissionType from permissions p, user u, document d where p.userId=u.userId and p.documentId=d.documentId and p.userId=$userId and d.createdBy=$userId";
